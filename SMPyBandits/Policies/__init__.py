...
from .MaxBandit import MaxBandit
from .maxb import MaximumBandit
from .qomax import Qomax_ETC, Qomax_SDA
...
from .RAWUCB import RAWUCB, EFF_RAWUCB, EFF_RAWUCB_pp, RAWUCB_pp, EFF_RAWklUCB
