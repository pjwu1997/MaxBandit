...
for problem in problems:
    ...
    for trials_per_arm in total_trials_per_arm:
        ## 同樣平均抽取次數，不同arms數
        file_name_1 = f'./saved_problems/{problem}/{dimension}/csv/fixed_times/{trials_per_arm}_mean.csv'
        file_name_2 = f'./saved_problems/{problem}/{dimension}/csv/fixed_times/{trials_per_arm}_std.csv'
