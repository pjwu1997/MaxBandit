...
for problem in problems:
    ...
    for trials_per_arm in total_trials_per_arm:
        file_name = f'./saved_problems/{problem}/{dimension}/csv/fixed_times/{trials_per_arm}_mean.csv'
        img_name = f'./saved_problems/{problem}/{dimension}/img/fixed_times/{trials_per_arm}_img.pdf'
        ...
        plt.legend()
        plt.title(f'Problem {problem}, with {trials_per_arm} pulls per arm.')
